...
public class TestBulletListTemplate extends AbstractBulletListTest {
    ...
    public void test() throws IOException {
        ...
        String expected = "";
        expected += "This is test simple template with one list variable: value01_1. null\n";
        expected += "\n";
        expected += "And second list variable: value02_1. null\n";
        expected += "And second list variable: value02_2. null\n";
        expected += "\n";
        expected += "And third: value03_1.null\n";
        expected += "And third: value03_2.null\n";
        expected += "And third: value03_3.null\n";
        expected += "\n";
        expected += "Same variables with new lines:\n";
        expected += "value01_1null\n";
        expected += "value02_1null\n";
        expected += "value02_2null\n";
        expected += "value03_1null\n";
        expected += "value03_2null\n";
        expected += "value03_3null\n";
        expected += "\n";
        expected += "\n";
